...
export default function SignIn() {
  ...
  // State for password visibility and email validation
      ...
      <div className="flex w-full items-center justify-center p-6 sm:p-12 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 text-center">
            <button
              onClick={() => navigate("/")}
              className="group inline-flex flex-col items-center gap-1 text-gray-500 transition-colors hover:text-gray-300"
            >
